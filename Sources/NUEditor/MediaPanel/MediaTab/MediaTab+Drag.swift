...
extension MediaTab {
    static let folderDragScheme = "nueditor-folder://"
    static let assetDragScheme = "nueditor-asset://"
    static let timelineDragScheme = "nueditor-timeline://"
    ...
    /// A search "moment": `nueditor-asset://<id>#<start>-<end>` in source seconds
