...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "nueditor-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "nueditor-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "nueditor-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "nueditor-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "nueditor-asset://x#junk") == "x")
    }
